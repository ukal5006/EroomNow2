...
export const eroomInfoList: EroomInfo[] = [
    ...
    {
        dutyName: '의료법인은혜와감사의료재단화성중앙종합병원',
    ...
    {
        dutyName: '학교법인가톨릭학원가톨릭대학교대전성모병원',
    ...
    {
        dutyName: '부산성모병원(재단법인 천주교부산교구유지재단)',
    ...
    {
        dutyName: '재단법인천주교부산교구유지재단 메리놀병원',
    ...
    {
        dutyName: '의료법인서울효천의료재단에이치플러스양지병원',
